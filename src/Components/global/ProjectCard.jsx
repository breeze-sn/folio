...
import { CHANGE_PAGE } from '../../store/Reducers/types';
...
function ProjectCard({ classname, style, project, index }) {
    ...
    return (
        <>
            <div className={`${styles.maincontainer} ${classname} ${hover ? styles.hover : null}`} data-theme={theme} style={style} onMouseEnter={() => { setHovering(true) }} onMouseLeave={() => { setHovering(false) }} onClick={() => { changepage(index - 1) }}>
                <b></b>
